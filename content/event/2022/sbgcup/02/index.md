---
title: "2. Salzburger Sportvoglcup 2022"
date: 2022-03-19T10:45:00 # keep time 0 until start time is known
draft: false
...
liveresultat_id: 21660
end: 150 # x minutes from event->date (remove if not needed)
start_amend: "(P - Start 300m)" # respects markdown
...
meeting:
  point: "Parkplatz Schmiedingerstraße"
  time_minutes: -45 # x minutes from event->date
  location: [47.83645, 13.01620]
map:
  name: "Salzachseen"
  scale: "1:4.000 oder 1:5000"
  equidistance: "2m"
  update: "März 2022"
  format: ""
